...
import com.github.manevolent.jbot.database.model.User;
...
public class PluginCommand extends AnnotatedCommandExecutor {
    ...
    private final SearchHandler<com.github.manevolent.jbot.database.model.Plugin> searchHandler;

    public PluginCommand(PluginManager pluginManager, Database database) {
        this.pluginManager = pluginManager;
        this.searchHandler = database
                .createSearchHandler(com.github.manevolent.jbot.database.model.Plugin.class)
    ...
    public void update(CommandSender sender,
        ...
        for (Plugin plugin : pluginManager.getLoadedPlugins()) {
            ...
            if (Version.fromString(latest.getVersion())
                    .compareTo(Version.fromString(artifactIdentifier.getVersion())) <= 0)
                continue;
